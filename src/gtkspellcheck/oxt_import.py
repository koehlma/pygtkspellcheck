...
"""oxt_import.py: Uncompress, read and install LibreOffice .oxt dictionaries extensions.
...
def deflate_oxt(oxt_path, extract_path, override=False, move_path=None):
    ...
    This functions does the following:
      Open all extensions found on oxt_path, find the dictionary definition file within, 
      find dictionary files and uncompress them to extract_path. By default
      file overriding is disabled, set override parameter to True if you want
      to enable it. As an option, each processed extension can be moved to
      move_path.
    """
