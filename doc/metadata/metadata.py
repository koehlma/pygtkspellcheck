...
description = {
    "short": "a simple but quite powerful Python spell checking library for GtkTextViews based on Enchant",
    "long": (
...
if __name__ == "__main__":
    ...
    with open(
        os.path.join(__path__, "..", "source", "index.rst"), "wb"
    ) as _documentation:
    ...
    if os.path.exists(koehlma_github):
        ...
        with open(
            os.path.join(koehlma_github, "projects", "pygtkspellcheck.md"), "wb"
        ) as _website:
